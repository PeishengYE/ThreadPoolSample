...
package com.radioyps.threadpoolsample;
...
public final class Constants {
    ...
    public static final String ACTION_VIEW_IMAGE =
            "com.radioyps.threadpoolsample.ACTION_VIEW_IMAGE";

    public static final String ACTION_ZOOM_IMAGE =
            "com.radioyps.threadpoolsample.ACTION_ZOOM_IMAGE";
    
    // Defines a custom Intent action
    public static final String BROADCAST_ACTION = "com.radioyps.threadpoolsample.BROADCAST";

    // Fragment tags
    public static final String PHOTO_FRAGMENT_TAG =
            "com.radioyps.threadpoolsample.PHOTO_FRAGMENT_TAG";
    
    public static final String THUMBNAIL_FRAGMENT_TAG =
            "com.radioyps.threadpoolsample.THUMBNAIL_FRAGMENT_TAG";

    // Defines the key for the status "extra" in an Intent
    public static final String EXTENDED_DATA_STATUS = "com.radioyps.threadpoolsample.STATUS";

    // Defines the key for the log "extra" in an Intent
    public static final String EXTENDED_STATUS_LOG = "com.radioyps.threadpoolsample.LOG";
    
    // Defines the key for storing fullscreen state
    public static final String EXTENDED_FULLSCREEN =
            "com.radioyps.threadpoolsample.EXTENDED_FULLSCREEN";
